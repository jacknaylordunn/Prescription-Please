...
export const medications: Medication[] = [
  ...
  { name: "Modafinil", category: "Stimulant", dose: "200mg", frequency: "Once daily in morning", indication: "Narcolepsy, excessive daytime sleepiness, MS fatigue", sideEffects: ["Headache", "Insomnia", "Anxiety", "Hypertension"], timeCritical: false, class: "Wakefulness-promoting agent" },
  { name: "Clobazam", category: "Benzodiazepine", dose: "10-30mg", frequency: "Once or twice daily", indication: "Epilepsy (adjunctive therapy), anxiety", sideEffects: ["Drowsiness", "Dependence", "Tolerance"], timeCritical: true, class: "Benzodiazepine (long-acting)" },
  { name: "Selegiline", category: "Antiparkinsonian", dose: "5-10mg", frequency: "Once daily in morning", indication: "Parkinson's disease (adjunct to levodopa)", sideEffects: ["Nausea", "Insomnia", "Postural hypotension", "Confusion"], timeCritical: true, class: "MAO-B inhibitor" },
  { name: "Vitamin D3", category: "Supplement", dose: "20,000 units", frequency: "Once weekly", indication: "Vitamin D deficiency", sideEffects: ["Hypercalcaemia if overdosed", "Nausea"], timeCritical: false, class: "Vitamin D3" },
  { name: "Adcal D3", category: "Supplement", dose: "1 tablet", frequency: "Twice daily", indication: "Calcium and Vitamin D supplementation, osteoporosis prevention", sideEffects: ["Constipation", "Flatulence", "Hypercalcaemia"], timeCritical: false, class: "Calcium carbonate + Vitamin D3 combination" },
  { name: "Chlordiazepoxide", category: "Benzodiazepine", dose: "5-25mg", frequency: "Reducing regime in alcohol withdrawal", indication: "Alcohol withdrawal syndrome", sideEffects: ["Drowsiness", "Dependence", "Confusion", "Ataxia"], timeCritical: true, class: "Benzodiazepine (long-acting)" },
  { name: "Vitamin B compound", category: "Supplement", dose: "1-2 tablets", frequency: "Three times daily", indication: "Vitamin B deficiency, alcohol-related deficiency", sideEffects: ["Minimal side effects", "Rare allergic reactions"], timeCritical: false, class: "B vitamin complex" },
  { name: "Rifaximin", category: "Antibiotic", dose: "550mg", frequency: "Twice daily", indication: "Hepatic encephalopathy, traveller's diarrhoea", sideEffects: ["Nausea", "Dizziness", "Abdominal pain"], timeCritical: false, class: "Rifamycin antibiotic (non-absorbed)" },
  { name: "Combined oral contraceptive", category: "Contraceptive", dose: "Variable", frequency: "Once daily for 21 days", indication: "Contraception, menstrual regulation", sideEffects: ["Nausea", "Breast tenderness", "Thromboembolism risk", "Mood changes"], timeCritical: false, class: "Combined hormonal contraceptive (oestrogen + progestogen)" }
];
